class PRIORIDAD{
    ...
    Resultados(){
        ...
        if(this.Ejecucion == null && this.colaProcesos.length!=0){
            this.Ejecucion = this.Prioritario();
    ...
    Prioritario(){
        ...
        let prioritario = this.colaProcesos[ultimo];
        while(ultimo>0){
            if(this.colaProcesos[ultimo -1].prioridad <= prioritario.prioridad){
                prioritario = this.colaProcesos[ultimo -1];
            }
            ultimo --;
        }
        this.colaProcesos = this.Eliminar(this.colaProcesos, prioritario.posicion)
        return prioritario;
    };
